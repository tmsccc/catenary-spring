...
namespace PSMS.BLL
{
    ...
    public class AttendanceBLL
    {
        ...
        //    /// <returns></returns>
        //    public List<AttendanceData> GetAllUsers(int isDel)
        //    {

        //        return dal.GetAllAttendanceData(isDel);
        //    }
        //    public List<AttendanceData> GetPartialUsers(DateTime? StartDate, DateTime? EndDate)
        //    {
